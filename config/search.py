...
bad_words = ["US Citizen", "Oracle", "Pre Sales", "Partner", "Data Architect", "MLOps", "Murex", "Data Engineer", "USA Citizen", "Back End", "HCM", "BlackChain", "No C2C", "ERP", "SAP", "Detection", "No Corp2Corp", ".NET", "Embedded Programming", "PHP", "Ruby", "CNC", "Alibaba", "Oracle", "XMCloud", "Emirati", "Java", "Ruby"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
