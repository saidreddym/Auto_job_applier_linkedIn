...
def apply_filters() -> None:
    ...
    try:
        ...
        # print_lg(e)
        pyautogui.confirm(text=f"Faced error while applying filters. Please make sure correct filters are selected, click on Show Results, then continue.\n\nERROR:\n{e}", title="LinkedIn Auto Apply", buttons=["Continue"])
